...
import 'package:todo_app_using_hive/utils/constant.dart';
import 'package:todo_app_using_hive/utils/strings.dart';
import 'package:todo_app_using_hive/view/Home/Widgets/task_widgets.dart';
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(MyString.mainTitle, style: textTheme.headline2),
                    const SizedBox(
                      height: 3,
                    ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text("Account name", style: textTheme.headline2),
